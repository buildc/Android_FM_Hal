...
/* driver definitions */
#define DRIVER_NAME "radio-si4704"
#define DRIVER_AUTHOR "NULL";
#define DRIVER_KERNEL_VERSION KERNEL_VERSION(1, 0, 1)
#define DRIVER_CARD "Silicon Labs Si4704 FM Radio Receiver"
#define DRIVER_DESC "I2C radio driver for Si4704 FM Radio Receivers"
...
#define	FM_BLEND_MULTIPATH_STEREO_THRESHOLD_SHIFT	0
...
#define	FM_BLEND_MULTIPATH_MONO_THRESHOLD_SHIFT		0
...
/*
 * si4704_device - private data
 */
struct si4704_device {
	...
	u16		blend_rssi_stereo_threshold;
	u16 	blend_rssi_mono_threshold;
	u16		blend_snr_stereo_threshold;
	u16 	blend_snr_mono_threshold;
	u16		blend_multi_stereo_threshold;
	u16 	blend_multi_mono_threshold;

	struct i2c_client 	*client;
	struct si4704_pdata *pdata;
	struct kobject		*kobj;
};
 ...
 * Common Functions
 **************************************************************************/
extern struct video_device si4704_viddev_template;
...
int si4704_get_int_status(struct si4704_device *radio, u8 *cts, u8 *err,
...
int si4704_fm_rds_status(struct si4704_device *radio, u8 mtfifo,
		...
		u8 *ble);
int si4704_fm_agc_status(struct si4704_device *radio, u8 *rfAgcDis,
		u8 *lnaGainIndex);
int si4704_fm_agc_override(struct si4704_device *radio, u8 *rfAgcDis,
		u8 *lnaGainIndex);
int si4704_gpio_ctl(struct si4704_device *radio, u8 gpio1,
		u8 gpio2, u8 gpio3);
int si4704_gpio_set(struct si4704_device *radio, u8 gpio1,
		u8 gpio2, u8 gpio3);
